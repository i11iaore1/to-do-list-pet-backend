...
from .views import UserTaskListView, UserTaskDetailView, UserTaskCloseView, UserTaskReissueView
...
urlpatterns = [
    ...
    path("user-tasks/<int:pk>/close/", UserTaskCloseView.as_view(), name="task-close"),
